...
void SAE_J1939_Read_Commanded_Address(J1939 *j1939, uint8_t data[]) {
	...
	j1939->information_this_ECU.this_name.identity_number = ((data[2] & 0x1F) << 16) | (data[1] << 8) | data[0];
	...
	j1939->information_this_ECU.this_name.ECU_instance = data[4] & 7;
	...
	j1939->information_this_ECU.this_name.industry_group = (data[7] >> 4) & 7;
	j1939->information_this_ECU.this_name.vehicle_system_instance = data[7] & 0x0F;
